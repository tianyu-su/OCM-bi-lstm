...
output_file = osp.join("../label_19", which_split, "{}_no_dup.json")
output_cp = osp.join("../label_19", which_split, "fashion_compatibility_prediction.txt")
output_fitb = osp.join("../label_19", which_split, "fill_in_blank_test.json")
output_retreival = osp.join("../label_19", which_split, "retrieval_test.json")
output_retreival_features = osp.join("../label_19", which_split, "retrieval_test_features.json")
output_set2id_mapping = osp.join("../label_19", which_split, "set2id_mapping.json")
